"use strict"
if (b4w.module_check("options_anims"))
    throw "Failed to register module: options_anims";
b4w.register("options_anims", function(exports, require) {
...
var _player_buttons = [
	...
	callback:  open_menu
	 ...
	 {
	 type:              "trigger_button",
     id:                "css_remove_0_button",                  
     callback:    remove_anims_css,	 
     replace_button_id: "css_play_0_button",            
     replace_button_cb: restablece_anims_css
	 }
	,
    {
	 type:              "trigger_button",
     id:                "fullscreen_0_on_button",                  
     callback:    enter_fullscreen,	 
     replace_button_id: "fullscreen_0_off_button",            
...
function cache_dom_elems() {
   _buttons_0_container = document.querySelector("#buttons_0_container");
     _opened_0_button = document.querySelector("#opened_0_button");
	   _css_remove_0_button = document.querySelector("#css_remove_0_button");
	 _hor_0_button_section = document.querySelector("#hor_0_button_section");
		_geometric_01 = document.getElementById("geometry_01");
	 	_geometric_02 = document.getElementById("geometry_02");
		_geometric_03 = document.getElementById("geometry_03");
		_geometric_04 = document.getElementById("geometry_04");
}							
...
function close_menu() {  
    ...
    var hor_elem  = document.querySelector("#css_remove_0_button")||document.querySelector("#css_play_0_button");
    var vert_elem = document.querySelector("#vert_0_section_button").firstElementChild;
    var drop_left = function(elem) {
        _is_anim_left = true;
		 elem.style.display = "";
		elem.style.marginRight = "-45px";
		elem.style.zIndex = 0;
            if (elem.previousElementSibling && elem.previousElementSibling.id != "opened_0_button")  
    ...
    var drop_top = function(elem) {
		...
		elem.style.zIndex = 0;
            if (elem.nextElementSibling && elem.nextElementSibling.id != "opened_0_button")
			{	elem.style.opacity = 0; 
...
function open_menu() {
    ...
    var hor_elem = document.querySelector("#fullscreen_0_on_button") ||
                   document.querySelector("#fullscreen_0_off_button");
    var vert_elem = document.querySelector("#vert_0_section_button").lastElementChild; 
    var drop_left = function(elem) {  
        _is_anim_left = true;
        elem.style.marginRight = "-45px";
        if ((elem.id == "css_remove_0_button") &&
...
function init_links() {
    var button_links = document.querySelectorAll(".control_0_panel_button a");  
...
function check_anim_end() {
    if (!is_anim_in_process()) {
        ...
        if ((!check_cursor_position("buttons_0_container") &&
	...
	if (!_is_hiden)   
		   {
			...
			_geometric_03.parentNode.removeChild(_geometric_03);	
			_geometric_04.parentNode.removeChild(_geometric_04);	
			console.log("se han detenido toda animacion de la portada tanto riged como css");
			_is_hiden=true;  
		   } 	   
  if (!check_cursor_position("buttons_0_container") && _is_anim_left)
        deferred_close();
    var css_anims_0_button = document.querySelector("#css_remove_0_button") ||
                            document.querySelector("#css_play_0_button");
    if (css_anims_0_button)
        update_button(css_anims_0_button);
}
function restablece_anims_css(geometric_01,geometric_02)  
{
 var start_cont=document.getElementById("start_cont");	   	
   _geometric_01=document.createElement("div");
    ...
    var opened_0_button=document.getElementById("opened_0_button");	
		opened_0_button.appendChild(_geometric_02);
		_geometric_02.id="geometry_02";
	opened_3_button.appendChild(_geometric_03);
		_geometric_03.id="geometry_03";
		opened_4_button.appendChild(_geometric_04);
		_geometric_04.id="geometry_04";
...
function fullscreen_cb(e) {
    if (!check_cursor_position("buttons_0_container") && _is_anim_left)
        deferred_close();
    var fullscreen_0_button = document.querySelector("#fullscreen_0_on_button") ||
                            document.querySelector("#fullscreen_0_off_button");
