"use strict"
if (b4w.module_check("options_3_anims"))
    throw "Failed to register module: options_3_anims";
b4w.register("options_3_anims", function(exports, require) {
...
var _player_buttons = [
	...
	,
   callback: function () {
	  	    console.log("no deberiamos ver ejecutarse esta nunca, close_4_help");	  	
	  }
	},
    {
	 type:              "trigger_button",
     id:                "fullscreen_3_on_button",                  
     callback:    function () {
		 console.log("a ver si vemos esto para el segundo boton a la izq desde el centro"); 
		window.open("https://www.n-dimensiones.es/main/wp-login.php","_self");  
		 },	 
     replace_button_id: "fullscreen_3_off_button",            
...
function cache_dom_elems() {
   _buttons_0_container = document.querySelector("#buttons_3_container");
     _opened_0_button = document.querySelector("#opened_3_button");
	   _help_0_button = document.querySelector("#help_3_button");
	 _hor_0_button_section = document.querySelector("#hor_3_button_section");
...
function close_menu() {  
    ...
    var hor_elem  = document.querySelector("#help_3_button");
    var vert_elem = document.querySelector("#vert_3_section_button").firstElementChild;
    var drop_left = function(elem) {
        _is_anim_left = true;
		 elem.style.display = "";
		elem.style.marginRight = "-45px";
		elem.style.zIndex = 0;
            if (elem.previousElementSibling && elem.previousElementSibling.id != "opened_3_button")  
    ...
    var drop_top = function(elem) {
		...
		elem.style.zIndex = 0;
            if (elem.nextElementSibling && elem.nextElementSibling.id != "opened_3_button")
			{	elem.style.opacity = 0; 
...
function open_menu() {
    ...
    var hor_elem = document.querySelector("#fullscreen_3_on_button") ||
                   document.querySelector("#fullscreen_3_off_button");
    var vert_elem = document.querySelector("#vert_3_section_button").lastElementChild;
    var drop_left = function(elem) {  
        _is_anim_left = true;
        elem.style.marginRight = "-45px";
        if ((elem.id == "help_3_button") &&
...
function init_links() {
    var button_links = document.querySelectorAll(".control_3_panel_button a");  
...
function check_anim_end() {
    if (!is_anim_in_process()) {
        ...
        if ((!check_cursor_position("buttons_3_container") &&
...
function restablece_anims_css(geometric_01,geometric_02)  
{
 var start_cont=document.getElementById("start_cont");	   	
   _geometric_01=document.createElement("div");
	  ...
	  var opened_0_button=document.getElementById("opened_3_button");	
...
function fullscreen_cb(e) {
    if (!check_cursor_position("buttons_3_container") && _is_anim_left)
        deferred_close();
    var fullscreen_0_button = document.querySelector("#fullscreen_3_on_button") ||
                            document.querySelector("#fullscreen_3_off_button");
